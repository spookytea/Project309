                    ...
                    onClick = {
                        try {
                            ...
                            Toast.makeText(context,
                                context.getString(R.string.invalid_number), Toast.LENGTH_SHORT).show()
                        }
                    },
                    modifier = Modifier
                        .align(Alignment.End)
...
fun ImportDialog(dismiss: () -> Unit){
    ...
    Dialog(dismiss) {
        Card(Modifier.size(500.dp)){
            Column {
                OutlinedTextField(import, {import=it}, Modifier
                    .weight(0.9f)
                    .padding(20.dp))
                TextButton(
                    onClick = {
                        try {
                            ...
                            Toast.makeText(context,
                                context.getString(R.string.invalid_exported_code), Toast.LENGTH_SHORT)
                                 .show()
